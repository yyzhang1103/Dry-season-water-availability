...
title('(a) Δlnf_{245}', 'FontSize', 12, 'FontWeight', 'bold');
...
title('(b) Δlnf_{585}', 'FontSize', 12, 'FontWeight', 'bold');
...
%%                                                    
h3 = axes('Position', [0.056,0.175,0.23,0.3]);
...
%  
h4 =axes('Position', [0.335,0.175,0.275,0.3]);
start_year = 2015;
end_year = 2100;
...
h5 = axes('Position', [0.68,0.175,0.275,0.3]);
start_year = 2015;
end_year = 2100;
